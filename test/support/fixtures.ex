defmodule Glific.Fixtures do
  ...
  * :downcase - generate lower case non-numeric random string
  ## Example
      iex> Fixtures.randomizer(20) //"Je5QaLj982f0Meb0ZBSK"
  """
  @spec randomizer(non_neg_integer(), atom()) :: String.t()
  ...
  @doc false
  @spec get_range(non_neg_integer()) :: [any()]
  defp get_range(length) when length > 1, do: 1..length
  defp get_range(_length), do: [1]

  @doc false
  @spec do_randomizer(non_neg_integer(), list()) :: String.t()
