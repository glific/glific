defmodule GlificWeb.Schema.Api.WaMessageTest do
  ...
  test "receive reaction successfully in wa messages", %{
    staff: user,
    conn: _conn
  } do
    mock_maytapi_response(200, %{
      ...
      "data" => %{
        ...
        "msgId" => "6606f5c3-e3a2-abce-20a8-e7e0b5060ae1"
      }
    })
      ...
      %{
        "data" => [
          %{
            ...
            "rxid" => "true_120363257477740000@g.us_3EB02136EF90BDDD70C2F5_918657048983@c.us",
            "time" => 1_732_784_398
          }
        ],
        "phoneId" => 47_309,
