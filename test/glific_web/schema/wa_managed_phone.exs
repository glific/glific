defmodule GlificWeb.Schema.WAManagedPhoneTest do
  ...
  alias Glific.WAManagedPhonesFixtures
  ...
  test "wa_managed_phones field returns list of wa_managed_phones", %{manager: user} = attrs do
    seed_wa_managed_phone = WAManagedPhonesFixtures.wa_managed_phone_fixture(attrs)
  ...
  test "wa_managed_phones field returns list of wa_managed_phones in desc order",
    ...
    _seed_wa_managed_phone_1 = WAManagedPhonesFixtures.wa_managed_phone_fixture(attrs)
    :timer.sleep(1000)

    valid_attrs_2 =
      Map.merge(attrs, %{phone: Phone.EnUs.phone()})

    seed_wa_managed_phone_2 = WAManagedPhonesFixtures.wa_managed_phone_fixture(valid_attrs_2)
  ...
  test "wa_managed_phones field returns list of wa_managed_phones in various filters",
       %{manager: user} = attrs do
    seed_wa_managed_phone_1 = WAManagedPhonesFixtures.wa_managed_phone_fixture(attrs)

    valid_attrs_2 =
      Map.merge(attrs, %{phone: Phone.EnUs.phone()})

    _seed_wa_managed_phone_2 = WAManagedPhonesFixtures.wa_managed_phone_fixture(valid_attrs_2)
