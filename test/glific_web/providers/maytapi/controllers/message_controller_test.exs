defmodule GlificWeb.Providers.Maytapi.Controllers.MessageControllerTest do
  ...
  describe "Phase 3: multi-phone inbound" do
    ...
    test "inbound from a second phone on an existing group does NOT create a duplicate wa_group and inserts a membership",
      ...
      # The describe-level setup already created wa_group for
      # "120363213149844251@g.us" via the first phone (917834811114).
      ...
      # The second phone's membership is not primary (the first phone created
      # the group, so it remains primary).
