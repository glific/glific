defmodule Glific.TemplatesTest do
  ...
  describe "session_template" do
    ...
    test "bulk_apply_templates/2 should bulk apply templates", attrs do
      ...
      assert message["Activity"] == "Template has been applied successfully"
      assert message["Help Arogya"] == "Invalid Language"
      assert message["Help Arogya 2"] == "Template has been applied successfully"
      assert message["Optin Arogya"] == "Invalid Button Type"
      assert message["Signout Arogya"] == "Message and Sample Message does not match"
      assert message["Signup Arogya"] == "Invalid Category"
      assert message["Signup Arogya 2"] == "Template has been applied successfully"
      assert message["Welcome Arogya"] == "Template has been applied successfully"
    end
