defmodule Glific.TemplatesTest do
  ...
  test "update_hsms/1 should correctly count unique parameters when same parameter appears multiple times",
       attrs do
    Tesla.Mock.mock(fn
      %{method: :post, url: "https://partner.gupshup.io/partner/account/login"} ->
        %Tesla.Env{
            ...
            Jason.encode!(%{
              ...
              "templates" => [
                %{
                  ...
                  "createdOn" => 1_595_904_220_466,
                  "data" =>
                    "*{{1}}* is your verification code. For your security, do not share this code. | [Copy OTP,https://www.whatsapp.com/otp/code/?otp_type=COPY_CODE&code=otp{{1}}]",
                  "elementName" => "otp_verification",
                  "id" => "3a826c4a-cacd-42b6-9536-ece4c459ffeb",
                  "languageCode" => "en",
                  "languagePolicy" => "deterministic",
                  "master" => false,
                  "meta" =>
                    "{\"example\":\"*123456* is your verification code. For your security, do not share this code. | [Copy OTP,https://www.whatsapp.com/otp/code/?otp_type=COPY_CODE&code=otp123456]\"}",
                  "modifiedOn" => 1_595_904_220_466,
                  "status" => "APPROVED",
                  "templateType" => "TEXT",
                  "vertical" => "ACTION_BUTTON"
    ...
    assert {:ok, %SessionTemplate{} = hsm} =
             Repo.fetch_by(SessionTemplate, %{uuid: "3a826c4a-cacd-42b6-9536-ece4c459ffeb"})

    assert hsm.number_parameters == 1
