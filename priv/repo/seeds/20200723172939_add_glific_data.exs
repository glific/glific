defmodule Glific.Repo.Seeds.AddGlificData do
  ...
  def flows(organization) do
    data = [
      ...
      {"SoL Activity", ["solactivity"], false, "sol_activity.json"},
      {"sol_feedback", ["solfeedback"], false, "sol_feedback.json"}
    ]
