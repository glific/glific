defmodule Glific.Repo.Seeds.AddGlificData_v0_5_2 do
  ...
  defp add_tags(organization_id) do
    ...
    if {:error, ["Elixir.Glific.Tags.Tag", "Resource not found"]} ==
         Repo.fetch_by(Tag, %{shortcode: "preferencepoetry", organization_id: organization_id}) do
      Repo.insert!(%Tag{
        label: "Preference Poetry",
        shortcode: "preferencepoetry",
        description: "Marking message received for the preference flow: poetry",
        is_reserved: false,
        language_id: en_us.id,
        parent_id: preference_tag.id,
        organization_id: organization_id
      })
    end

    if {:error, ["Elixir.Glific.Tags.Tag", "Resource not found"]} ==
         Repo.fetch_by(Tag, %{shortcode: "preferencewriting", organization_id: organization_id}) do
      Repo.insert!(%Tag{
        label: "Preference Writing",
        shortcode: "preferencewriting",
        description: "Marking message received for the preference flow: writing",
        is_reserved: false,
        language_id: en_us.id,
        parent_id: preference_tag.id,
        organization_id: organization_id
    ...
    if {:error, ["Elixir.Glific.Tags.Tag", "Resource not found"]} ==
         Repo.fetch_by(Tag, %{shortcode: "preferencestory", organization_id: organization_id}) do
      Repo.insert!(%Tag{
        label: "Preference Story",
        shortcode: "preferencestory",
        description: "Marking message received for the preference flow: story",
        is_reserved: false,
        language_id: en_us.id,
        parent_id: preference_tag.id,
        organization_id: organization_id
    ...
    if {:error, ["Elixir.Glific.Tags.Tag", "Resource not found"]} ==
         Repo.fetch_by(Tag, %{shortcode: "preferencevideo", organization_id: organization_id}) do
      Repo.insert!(%Tag{
        label: "Preference Video",
        shortcode: "preferencevideo",
        description: "Marking message received for the preference flow: video",
        is_reserved: false,
        language_id: en_us.id,
        parent_id: preference_tag.id,
        organization_id: organization_id
    ...
    if {:error, ["Elixir.Glific.Tags.Tag", "Resource not found"]} ==
         Repo.fetch_by(Tag, %{shortcode: "preferencereset", organization_id: organization_id}) do
      Repo.insert!(%Tag{
        label: "Preference Reset",
        shortcode: "preferencereset",
        description: "Marking message received for the preference flow: reset",
        is_reserved: false,
        language_id: en_us.id,
        parent_id: preference_tag.id,
        organization_id: organization_id
