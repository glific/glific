...
defmodule Glific.Seeds.Credentials do
  ...
  def insert_chatbase_credentials(chatbase, organization_id) do
    {:ok, chatbase_db} = Repo.fetch_by(Provider, %{shortcode: "chatbase"}, skip_organization_id: true)
  ...
  def insert_biqquery_credentials(bigquery, organization_id) do
    {:ok, bigquery_db} = Repo.fetch_by(Provider, %{shortcode: "bigquery"}, skip_organization_id: true)
  ...
  def insert_gcs_credentials(gcs, organization_id) do
    {:ok, gcs_db} = Repo.fetch_by(Provider, %{shortcode: "google_cloud_storage"}, skip_organization_id: true)
