...
CREATE TYPE global.oban_job_state AS ENUM ('available', 'scheduled', 'executing', 'retryable', 'completed', 'discarded', 'cancelled');

--
-- Name: api_status_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.api_status_enum AS ENUM ('ok', 'error');

--
-- Name: contact_field_scope_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.contact_field_scope_enum AS ENUM ('contact', 'globals');

--
-- Name: contact_field_value_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.contact_field_value_type_enum AS ENUM ('text', 'integer', 'number', 'boolean', 'date');

--
-- Name: contact_provider_status_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.contact_provider_status_enum AS ENUM ('none', 'session', 'session_and_hsm', 'hsm');

--
-- Name: contact_status_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.contact_status_enum AS ENUM ('blocked', 'failed', 'invalid', 'processing', 'valid');

--
-- Name: flow_action_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.flow_action_type_enum AS ENUM ('enter_flow', 'send_msg', 'set_contact_language', 'wait_for_response', 'set_contact_field');

--
-- Name: flow_case_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.flow_case_enum AS ENUM ('has_any_word');

--
-- Name: flow_router_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.flow_router_enum AS ENUM ('switch');

--
-- Name: flow_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.flow_type_enum AS ENUM ('message');

--
-- Name: import_contacts_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.import_contacts_type_enum AS ENUM ('file_path', 'url', 'data');

--
-- Name: interactive_message_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.interactive_message_type_enum AS ENUM ('list', 'quick_reply');

--
-- Name: message_flow_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.message_flow_enum AS ENUM ('inbound', 'outbound');

--
-- Name: message_status_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.message_status_enum AS ENUM ('sent', 'delivered', 'enqueued', 'error', 'read', 'received', 'contact_opt_out');

--
-- Name: message_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.message_type_enum AS ENUM ('audio', 'contact', 'document', 'hsm', 'image', 'location', 'list', 'quick_reply', 'text', 'video', 'sticker');

--
-- Name: organization_status_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.organization_status_enum AS ENUM ('inactive', 'approved', 'active', 'suspended', 'ready_to_delete');

--
-- Name: question_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.question_type_enum AS ENUM ('text', 'numeric', 'date');

--
-- Name: sort_order_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.sort_order_enum AS ENUM ('asc', 'desc');

--
-- Name: template_button_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.template_button_type_enum AS ENUM ('call_to_action', 'quick_reply');

--
-- Name: user_roles_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.user_roles_enum AS ENUM ('none', 'staff', 'manager', 'admin', 'glific_admin');

--
-- Name: oban_jobs_notify(); Type: FUNCTION; Schema: global; Owner: -
--

CREATE FUNCTION global.oban_jobs_notify() RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  channel text;
  notice json;
BEGIN
...
CREATE FUNCTION public.message_after_insert_callback() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.message_before_insert_callback() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.remove_old_history() RETURNS trigger LANGUAGE plpgsql AS $$
  BEGIN
...
CREATE FUNCTION public.update_contact_updated_at() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_contact_updated_at_on_tagging() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_flow_revision_number() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  IF (TG_OP = 'INSERT') THEN
...
CREATE FUNCTION public.update_message_number() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_message_updated_at() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_organization_id() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_profile_id_on_new_contact_history() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_profile_id_on_new_flow_context() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_profile_id_on_new_flow_result() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_profile_id_on_new_message() RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE FUNCTION public.update_tag_ancestors() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
...
CREATE TABLE global.fun_with_flags_toggles (id bigint NOT NULL,
...
CREATE TABLE global.languages (id bigint NOT NULL,
                                         label character varying(255) NOT NULL,
                                                                      label_locale character varying(255) NOT NULL,
                                                                                                          description text, locale character varying(255) NOT NULL,
...
CREATE TABLE global.oban_jobs (id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                             scheduled_at timestamp without time zone DEFAULT timezone('UTC'::text, now()) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                           attempted_at timestamp without time zone,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               completed_at timestamp without time zone,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   attempted_by text[], discarded_at timestamp without time zone,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            priority integer DEFAULT 0 NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       tags character varying(255)[] DEFAULT ARRAY[]::character varying[], meta jsonb DEFAULT '{}'::jsonb,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              cancelled_at timestamp without time zone,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  CONSTRAINT attempt_range CHECK (((attempt >= 0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   AND (attempt <= max_attempts))), CONSTRAINT positive_max_attempts CHECK ((max_attempts > 0)), CONSTRAINT priority_range CHECK (((priority >= 0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   AND (priority <= 3))), CONSTRAINT queue_length CHECK (((char_length(queue) > 0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          AND (char_length(queue) < 128))), CONSTRAINT worker_length CHECK (((char_length(worker) > 0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             AND (char_length(worker) < 128))));
...
CREATE UNLOGGED TABLE global.oban_peers (name text NOT NULL,
                                                   node text NOT NULL,
...
CREATE UNLOGGED TABLE global.oban_producers (uuid uuid NOT NULL,
                                                       name text NOT NULL,
                                                                 node text NOT NULL,
                                                                           queue text NOT NULL,
...
CREATE TABLE global.permissions (id bigint NOT NULL,
...
CREATE TABLE global.providers (id bigint NOT NULL,
...
CREATE TABLE public.bigquery_jobs (id bigint NOT NULL,
                                             "table" character varying(255),
                                                               table_id integer, organization_id bigint NOT NULL,
                                                                                                        inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                   updated_at timestamp(0) without time zone NOT NULL,
...
CREATE TABLE public.billings (id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                     name character varying(255),
                                                                                                                                                                                                                                                                                                                                                                                                    email character varying(255),
                                                                                                                                                                                                                                                                                                                                                                                                                    currency character varying(255),
                                                                                                                                                                                                                                                                                                                                                                                                                                       is_delinquent boolean, is_active boolean DEFAULT true,
...
CREATE TABLE public.consulting_hours (id bigint NOT NULL,
                                                organization_id bigint, organization_name character varying(255),
                                                                                                    participants text, staff text, "when" timestamp(0) without time zone,
                                                                                                                                                                    duration integer, content text, is_billable boolean DEFAULT true,
                                                                                                                                                                                                                                inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                           updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.contact_histories (id bigint NOT NULL,
                                                 contact_id bigint NOT NULL,
                                                                   event_type character varying(255),
                                                                                        event_label text, event_meta jsonb DEFAULT '{}'::jsonb,
...
CREATE TABLE public.contacts (id bigint NOT NULL,
                                        name character varying(255),
...
CREATE TABLE public.contacts_fields (id bigint NOT NULL,
                                               name character varying(255),
                                                              shortcode character varying(255),
...
CREATE TABLE public.contacts_groups (id bigint NOT NULL,
                                               contact_id bigint NOT NULL,
...
CREATE TABLE public.contacts_tags (id bigint NOT NULL,
                                             contact_id bigint NOT NULL,
...
CREATE TABLE public.credentials (id bigint NOT NULL,
                                           keys jsonb DEFAULT '{}'::jsonb,
                                                              secrets bytea,
...
CREATE TABLE public.extensions (id bigint NOT NULL,
                                          name character varying(255),
                                                         code text, module character varying(255),
                                                                                     is_valid boolean DEFAULT false,
                                                                                                              is_active boolean DEFAULT true,
                                                                                                                                        organization_id bigint, inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                           updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.message_broadcast_contacts (id bigint NOT NULL,
...
CREATE TABLE public.message_broadcasts (id bigint NOT NULL,
                                                  flow_id bigint, group_id bigint NOT NULL,
                                                                                  message_id bigint, user_id bigint, organization_id bigint NOT NULL,
...
CREATE TABLE public.flow_contexts (id bigint NOT NULL,
                                             node_uuid uuid,
                                             flow_uuid uuid NOT NULL,
                                                            contact_id bigint NOT NULL,
                                                                              flow_id bigint NOT NULL,
                                                                                             results jsonb DEFAULT '{}'::jsonb,
                                                                                                                   parent_id bigint, wakeup_at timestamp(0) without time zone DEFAULT NULL::timestamp without time zone,
                                                                                                                                                                                                                   completed_at timestamp(0) without time zone DEFAULT NULL::timestamp without time zone,
                                                                                                                                                                                                                                                                                                    recent_inbound jsonb DEFAULT '[]'::jsonb,
                                                                                                                                                                                                                                                                                                                                 recent_outbound jsonb DEFAULT '[]'::jsonb,
                                                                                                                                                                                                                                                                                                                                                               inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                          updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                    status character varying(255) DEFAULT 'published'::character varying, organization_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 is_background_flow boolean DEFAULT false,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    group_message_id bigint, message_broadcast_id bigint, is_await_result boolean DEFAULT false,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          is_killed boolean DEFAULT false,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    profile_id bigint, reason character varying(255));
...
CREATE TABLE public.flow_counts (id bigint NOT NULL,
                                           uuid uuid NOT NULL,
                                                                    ...
                                                                    flow_uuid uuid NOT NULL,
                                                                                   type character varying(255),
                                                                                                  count integer DEFAULT 1,
                                                                                                                        recent_messages jsonb[] DEFAULT ARRAY[]::jsonb[], inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                     updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                               organization_id bigint NOT NULL);
...
CREATE TABLE public.flow_labels (id bigint NOT NULL,
                                           uuid uuid NOT NULL,
                                                     name character varying(255),
                                                                    organization_id bigint NOT NULL,
                                                                                           inserted_at timestamp(0) without time zone NOT NULL,
...
CREATE TABLE public.flow_results (id bigint NOT NULL,
                                            results jsonb DEFAULT '{}'::jsonb,
                                                                  contact_id bigint NOT NULL,
                                                                                    flow_id bigint NOT NULL,
                                                                                                   flow_uuid uuid NOT NULL,
                                                                                                                  flow_version integer DEFAULT 1 NOT NULL,
                                                                                                                                                 organization_id bigint NOT NULL,
                                                                                                                                                                        inserted_at timestamp without time zone NOT NULL,
                                                                                                                                                                                                                updated_at timestamp without time zone NOT NULL,
                                                                                                                                                                                                                                                       flow_context_id bigint, profile_id bigint);
...
CREATE TABLE public.flow_revisions (id bigint NOT NULL,
                                              definition jsonb,
                                              flow_id bigint NOT NULL,
                                                             revision_number integer DEFAULT 0,
                                                                                             status character varying(255) DEFAULT 'draft'::character varying, inserted_at timestamp without time zone NOT NULL,
                                                                                                                                                                                                       updated_at timestamp without time zone NOT NULL,
...
CREATE TABLE public.flow_roles (id bigint NOT NULL,
...
CREATE TABLE public.flows (id bigint NOT NULL,
                                     name character varying(255) NOT NULL,
                                                                 uuid uuid NOT NULL,
                                                                           version_number character varying(255) DEFAULT '13.1.0'::character varying, flow_type public.flow_type_enum DEFAULT 'message'::public.flow_type_enum NOT NULL,
                                                                                                                                                                                                                               ignore_keywords boolean DEFAULT false,
                                                                                                                                                                                                                                                               keywords character varying(255)[] DEFAULT ARRAY[]::character varying[], organization_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                              inserted_at timestamp without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                      updated_at timestamp without time zone NOT NULL,
...
CREATE TABLE public.gcs_jobs (id bigint NOT NULL,
                                        message_media_id bigint, organization_id bigint NOT NULL,
                                                                                        inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                   updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.group_roles (id bigint NOT NULL,
                                           role_id bigint NOT NULL,
                                                          group_id bigint NOT NULL,
                                                                          organization_id bigint NOT NULL);
...
CREATE TABLE public.groups (id bigint NOT NULL,
                                      label character varying(255) NOT NULL,
                                                                   description text, is_restricted boolean DEFAULT false,
                                                                                                                   organization_id bigint NOT NULL,
                                                                                                                                          inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                     updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                               last_communication_at timestamp(0) without time zone,
...
CREATE TABLE public.intents (id bigint NOT NULL,
                                       name character varying(255),
                                                      organization_id bigint, inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                         updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.interactive_templates (id bigint NOT NULL,
...
CREATE TABLE public.invoices (id bigint NOT NULL,
...
CREATE TABLE public.locations (id bigint NOT NULL,
                                         contact_id bigint NOT NULL,
...
CREATE TABLE public.mail_logs (id bigint NOT NULL,
...
CREATE TABLE public.messages (id bigint NOT NULL,
                                        uuid uuid,
                                        body text, type public.message_type_enum,
                                                        is_hsm boolean DEFAULT false,
                                                                               ...
                                                                               status public.message_status_enum DEFAULT 'enqueued'::public.message_status_enum NOT NULL,
                                                                                                                                                                bsp_message_id text, bsp_status public.message_status_enum,
                                                                                                                                                                                     errors jsonb,
                                                                                                                                                                                     message_number bigint, sender_id bigint NOT NULL,
                                                                                                                                                                                                                             receiver_id bigint NOT NULL,
                                                                                                                                                                                                                                                contact_id bigint NOT NULL,
                                                                                                                                                                                                                                                                  user_id bigint, media_id bigint, send_at timestamp(0) without time zone,
                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                              inserted_at timestamp without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                      updated_at timestamp without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             flow_label character varying(255),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  flow_id bigint, group_id bigint, context_id text, context_message_id bigint, interactive_content jsonb DEFAULT '{}'::jsonb,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 group_message_id bigint, template_id bigint, interactive_template_id bigint, message_broadcast_id bigint, profile_id bigint);
...
CREATE TABLE public.messages_conversations (id bigint NOT NULL,
                                                      conversation_id text, deduction_type character varying(255),
                                                                                                     is_billable boolean DEFAULT false,
                                                                                                                                 message_id bigint, organization_id bigint NOT NULL,
...
CREATE TABLE public.messages_media (id bigint NOT NULL,
                                              url text NOT NULL,
                                                       source_url text NOT NULL,
                                                                       thumbnail text, caption text, provider_media_id character varying(255),
                                                                                                                                 inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                            updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                      gcs_url text, organization_id bigint NOT NULL,
...
CREATE TABLE public.messages_tags (id bigint NOT NULL,
                                             message_id bigint NOT NULL,
                                                               tag_id bigint NOT NULL,
                                                                             value character varying(255),
                                                                                             organization_id bigint NOT NULL);
...
CREATE TABLE public.notifications (id bigint NOT NULL,
                                             entity jsonb DEFAULT '{}'::jsonb,
                                                                  category character varying(255),
                                                                                     message text, severity text DEFAULT 'Error'::text,
                                                                                                                         organization_id bigint NOT NULL,
                                                                                                                                                inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                           updated_at timestamp(0) without time zone NOT NULL,
...
CREATE TABLE public.organization_data (id bigint NOT NULL,
                                                 key character varying(255) NOT NULL,
                                                                            description character varying(255),
                                                                                                  json jsonb DEFAULT '{}'::jsonb, text text, organization_id bigint NOT NULL,
                                                                                                                                                                    inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                               updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.organizations (id bigint NOT NULL,
                                             name character varying(255) NOT NULL,
                                                                         shortcode character varying(255) NOT NULL,
                                                                                                          email character varying(255) NOT NULL,
                                                                                                                                       bsp_id bigint NOT NULL,
                                                                                                                                                     default_language_id bigint NOT NULL,
                                                                                                                                                                                active_language_ids integer[] DEFAULT ARRAY[]::integer[], contact_id integer, out_of_office jsonb,
                                                                                                                                                                                                                                                              is_active boolean DEFAULT true,
                                                                                                                                                                                                                                                                                        timezone character varying(255),
                                                                                                                                                                                                                                                                                                           inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                      updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                session_limit integer DEFAULT 60,
                                                                                                                                                                                                                                                                                                                                                                                                                              organization_id bigint, signature_phrase bytea,
                                                                                                                                                                                                                                                                                                                                                                                                                                                      last_communication_at timestamp(0) without time zone,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      is_approved boolean DEFAULT false,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  fields jsonb DEFAULT '{}'::jsonb,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       status public.organization_status_enum DEFAULT 'inactive'::public.organization_status_enum,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      newcontact_flow_id bigint, is_suspended boolean DEFAULT false,
...
CREATE TABLE public.profiles (id bigint NOT NULL,
                                        name character varying(255),
                                                       contact_id bigint NOT NULL,
                                                                         language_id bigint NOT NULL,
                                                                                            organization_id bigint NOT NULL,
...
CREATE TABLE public.role_permissions (id bigint NOT NULL,
                                                role_id bigint NOT NULL,
...
CREATE TABLE public.roles (id bigint NOT NULL,
                                     label character varying(255),
                                                     description character varying(255),
...
CREATE TABLE public.saas (id bigint NOT NULL,
                                    name character varying(255),
                                                   organization_id bigint, phone character varying(255),
...
CREATE TABLE public.saved_searches (id bigint NOT NULL,
                                              label character varying(255) NOT NULL,
                                                                           args jsonb,
                                                                           shortcode character varying(255),
...
CREATE TABLE public.schema_seeds (version bigint NOT NULL,
...
CREATE TABLE public.session_templates (id bigint NOT NULL,
                                                 uuid uuid NOT NULL,
                                                           label character varying(255) NOT NULL,
                                                                                        body text, type public.message_type_enum,
                                                                                                        is_reserved boolean DEFAULT false,
                                                                                                                                    is_active boolean DEFAULT true,
                                                                                                                                                              is_source boolean DEFAULT false,
                                                                                                                                                                                        shortcode character varying(255),
                                                                                                                                                                                                            is_hsm boolean DEFAULT false,
                                                                                                                                                                                                                                   number_parameters integer, language_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                 parent_id bigint, message_media_id bigint, organization_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                   inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                              updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                        translations jsonb DEFAULT '{}'::jsonb,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   status character varying(255),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    category character varying(255),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       example text, has_buttons boolean DEFAULT false,
...
CREATE TABLE public.sheets (id bigint NOT NULL,
                                      label character varying(255) NOT NULL,
                                                                                              ...
                                                                                              is_active boolean DEFAULT true,
                                                                                                                        last_synced_at timestamp(0) without time zone DEFAULT now(),
                                                                                                                                                                              organization_id bigint NOT NULL,
                                                                                                                                                                                                     inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                          sheet_data_count integer, type character varying(255));
...
CREATE TABLE public.sheets_data (id bigint NOT NULL,
                                           key character varying(255) NOT NULL,
...
CREATE TABLE public.stats (id bigint NOT NULL,
                                     contacts integer, active integer, optin integer, optout integer, messages integer, inbound integer, outbound integer, hsm integer, flows_started integer, flows_completed integer, users integer, period character varying(255), date date, hour integer, organization_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                      inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                 updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.tags (id bigint NOT NULL,
                                    label character varying(255) NOT NULL,
                                                                 shortcode character varying(255) NOT NULL,
                                                                                                  description text, is_active boolean DEFAULT true,
                                                                                                                                              is_reserved boolean DEFAULT false,
                                                                                                                                                                          ancestors bigint[], is_value boolean DEFAULT false,
                                                                                                                                                                                                                       keywords character varying(255)[], color_code character varying(255) DEFAULT '#0C976D'::character varying, language_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                     parent_id bigint, organization_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                              inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                         updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.templates_tags (id bigint NOT NULL,
...
CREATE TABLE public.tickets (id bigint NOT NULL,
                                       body character varying(255),
                                                      topic character varying(255),
                                                                      status character varying(255),
                                                                                       remarks character varying(255),
                                                                                                         contact_id bigint NOT NULL,
                                                                                                                           user_id bigint, organization_id bigint NOT NULL,
                                                                                                                                                                  inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                             updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.trackers (id bigint NOT NULL,
                                        period character varying(255), date date, counts jsonb,
                                                                                  organization_id bigint NOT NULL,
                                                                                                         inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                    updated_at timestamp(0) without time zone NOT NULL);
...
CREATE TABLE public.trigger_logs (id bigint NOT NULL,
...
CREATE TABLE public.trigger_roles (id bigint NOT NULL,
                                             role_id bigint NOT NULL,
                                                            trigger_id bigint NOT NULL,
                                                                              organization_id bigint NOT NULL);
...
CREATE TABLE public.triggers (id bigint NOT NULL,
                                        name character varying(255),
                                                       trigger_type character varying(255) DEFAULT 'scheduled'::character varying, group_id bigint, flow_id bigint, start_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                            end_date date, last_trigger_at timestamp(0) without time zone,
                                                                                                                                                                                                                                                                     next_trigger_at timestamp(0) without time zone,
                                                                                                                                                                                                                                                                                                               is_repeating boolean DEFAULT false,
                                                                                                                                                                                                                                                                                                                                            frequency character varying(255)[] DEFAULT ARRAY[]::character varying[], days integer[] DEFAULT ARRAY[]::integer[], is_active boolean DEFAULT true,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          organization_id bigint NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            updated_at timestamp(0) without time zone NOT NULL,
...
CREATE TABLE public.user_roles (id bigint NOT NULL,
...
CREATE TABLE public.users (id bigint NOT NULL,
                                     phone character varying(255) NOT NULL,
                                                                  password_hash character varying(255),
                                                                                          name character varying(255),
                                                                                                         roles public.user_roles_enum[] DEFAULT ARRAY['none'::public.user_roles_enum], contact_id bigint NOT NULL,
                                                                                                                                                                                                         organization_id bigint NOT NULL,
                                                                                                                                                                                                                                inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                           updated_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                                                     is_restricted boolean DEFAULT false,
                                                                                                                                                                                                                                                                                                                                                   last_login_at timestamp(0) without time zone DEFAULT NULL::timestamp without time zone,
                                                                                                                                                                                                                                                                                                                                                                                                                                     last_login_from character varying(255) DEFAULT NULL::character varying, language_id bigint, upload_contacts boolean DEFAULT false,
...
CREATE TABLE public.users_groups (id bigint NOT NULL,
                                            user_id bigint NOT NULL,
                                                           group_id bigint NOT NULL,
                                                                           organization_id bigint NOT NULL);
...
CREATE TABLE public.users_tokens (id bigint NOT NULL,
                                            user_id bigint NOT NULL,
...
CREATE TABLE public.webhook_logs (id bigint NOT NULL,
                                            url text NOT NULL,
                                                     method text NOT NULL,
                                                                 request_headers jsonb DEFAULT '{}'::jsonb,
                                                                                               request_json jsonb DEFAULT '{}'::jsonb,
                                                                                                                          response_json jsonb DEFAULT '{}'::jsonb,
                                                                                                                                                      status_code integer, error text, flow_id bigint NOT NULL,
                                                                                                                                                                                                      contact_id bigint NOT NULL,
                                                                                                                                                                                                                        organization_id bigint NOT NULL,
                                                                                                                                                                                                                                               inserted_at timestamp(0) without time zone NOT NULL,
                                                                                                                                                                                                                                                                                          updated_at timestamp(0) without time zone NOT NULL);
...
ALTER COLUMN id
SET DEFAULT nextval('global.fun_with_flags_toggles_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('global.languages_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('global.oban_jobs_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('global.permissions_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('global.providers_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.bigquery_jobs_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.billings_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.consulting_hours_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.contact_histories_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.contacts_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.contacts_fields_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.contacts_groups_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.contacts_tags_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.credentials_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.extensions_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_contexts_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_counts_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_labels_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_results_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_revisions_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_roles_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flows_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.gcs_jobs_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.group_roles_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.groups_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.intents_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.interactive_templates_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.mail_logs_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_broadcast_contacts_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.flow_broadcasts_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.messages_conversations_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.messages_media_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.messages_tags_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.organization_data_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.profiles_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.role_permissions_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.saas_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.saved_searches_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.session_templates_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.sheets_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.sheets_data_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.stats_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.templates_tags_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.tickets_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.trackers_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.trigger_logs_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.trigger_roles_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.triggers_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.users_groups_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.users_tokens_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('public.webhook_logs_id_seq'::regclass);

--
-- Name: fun_with_flags_toggles fun_with_flags_toggles_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.fun_with_flags_toggles ADD CONSTRAINT fun_with_flags_toggles_pkey PRIMARY KEY (id);

--
-- Name: languages languages_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.languages ADD CONSTRAINT languages_pkey PRIMARY KEY (id);

--
-- Name: oban_jobs oban_jobs_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.oban_jobs ADD CONSTRAINT oban_jobs_pkey PRIMARY KEY (id);

--
-- Name: oban_peers oban_peers_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.oban_peers ADD CONSTRAINT oban_peers_pkey PRIMARY KEY (name);

--
-- Name: oban_producers oban_producers_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.oban_producers ADD CONSTRAINT oban_producers_pkey PRIMARY KEY (uuid);

--
-- Name: permissions permissions_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.permissions ADD CONSTRAINT permissions_pkey PRIMARY KEY (id);

--
-- Name: providers providers_pkey; Type: CONSTRAINT; Schema: global; Owner: -
--

ALTER TABLE ONLY global.providers ADD CONSTRAINT providers_pkey PRIMARY KEY (id);

--
-- Name: bigquery_jobs bigquery_jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bigquery_jobs ADD CONSTRAINT bigquery_jobs_pkey PRIMARY KEY (id);

--
-- Name: billings billings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.billings ADD CONSTRAINT billings_pkey PRIMARY KEY (id);

--
-- Name: consulting_hours consulting_hours_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consulting_hours ADD CONSTRAINT consulting_hours_pkey PRIMARY KEY (id);

--
-- Name: contact_histories contact_histories_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_histories ADD CONSTRAINT contact_histories_pkey PRIMARY KEY (id);

--
-- Name: contacts_fields contacts_fields_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contacts_fields ADD CONSTRAINT contacts_fields_pkey PRIMARY KEY (id);

--
-- Name: contacts_groups contacts_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contacts_groups ADD CONSTRAINT contacts_groups_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.contacts_tags ADD CONSTRAINT contacts_tags_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.extensions ADD CONSTRAINT extensions_pkey PRIMARY KEY (id);

--
-- Name: message_broadcast_contacts flow_broadcast_contacts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.message_broadcast_contacts ADD CONSTRAINT flow_broadcast_contacts_pkey PRIMARY KEY (id);

--
-- Name: message_broadcasts flow_broadcasts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT flow_broadcasts_pkey PRIMARY KEY (id);

--
-- Name: flow_contexts flow_contexts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_pkey PRIMARY KEY (id);

--
-- Name: flow_counts flow_counts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flow_counts ADD CONSTRAINT flow_counts_pkey PRIMARY KEY (id);

--
-- Name: flow_labels flow_labels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flow_labels ADD CONSTRAINT flow_labels_pkey PRIMARY KEY (id);

--
-- Name: flow_results flow_results_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flow_results ADD CONSTRAINT flow_results_pkey PRIMARY KEY (id);

--
-- Name: flow_revisions flow_revisions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flow_revisions ADD CONSTRAINT flow_revisions_pkey PRIMARY KEY (id);

--
-- Name: flow_roles flow_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flow_roles ADD CONSTRAINT flow_roles_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.gcs_jobs ADD CONSTRAINT gcs_jobs_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.intents ADD CONSTRAINT intents_pkey PRIMARY KEY (id);

--
-- Name: interactive_templates interactive_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interactive_templates ADD CONSTRAINT interactive_templates_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.mail_logs ADD CONSTRAINT mail_logs_pkey PRIMARY KEY (id);

--
-- Name: messages_conversations messages_conversations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.messages_conversations ADD CONSTRAINT messages_conversations_pkey PRIMARY KEY (id);

--
-- Name: messages_media messages_media_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.messages_media ADD CONSTRAINT messages_media_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.messages_tags ADD CONSTRAINT messages_tags_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.organization_data ADD CONSTRAINT organization_data_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.saas ADD CONSTRAINT saas_pkey PRIMARY KEY (id);

--
-- Name: saved_searches saved_searches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.saved_searches ADD CONSTRAINT saved_searches_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.schema_seeds ADD CONSTRAINT schema_seeds_pkey PRIMARY KEY (version,
                                                                                   tenant);
...
ALTER TABLE ONLY public.session_templates ADD CONSTRAINT session_templates_pkey PRIMARY KEY (id);

--
-- Name: sheets_data sheets_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sheets_data ADD CONSTRAINT sheets_data_pkey PRIMARY KEY (id);

--
-- Name: sheets sheets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sheets ADD CONSTRAINT sheets_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.templates_tags ADD CONSTRAINT templates_tags_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.trackers ADD CONSTRAINT trackers_pkey PRIMARY KEY (id);

--
-- Name: trigger_logs trigger_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trigger_logs ADD CONSTRAINT trigger_logs_pkey PRIMARY KEY (id);

--
-- Name: trigger_roles trigger_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trigger_roles ADD CONSTRAINT trigger_roles_pkey PRIMARY KEY (id);

--
-- Name: triggers triggers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.triggers ADD CONSTRAINT triggers_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.users_groups ADD CONSTRAINT users_groups_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.users_tokens ADD CONSTRAINT users_tokens_pkey PRIMARY KEY (id);
...
CREATE TRIGGER oban_notify AFTER
INSERT ON global.oban_jobs
FOR EACH ROW EXECUTE FUNCTION global.oban_jobs_notify();

--
-- Name: tags delete_tag_ancestors_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER delete_tag_ancestors_trigger AFTER
DELETE ON public.tags
FOR EACH STATEMENT EXECUTE FUNCTION public.update_tag_ancestors();

--
-- Name: tags insert_tag_ancestors_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER insert_tag_ancestors_trigger AFTER
INSERT ON public.tags
FOR EACH STATEMENT EXECUTE FUNCTION public.update_tag_ancestors();
...
CREATE TRIGGER message_after_insert_trigger AFTER
INSERT ON public.messages
FOR EACH ROW EXECUTE FUNCTION public.message_after_insert_callback();
...
BEFORE
INSERT ON public.messages
FOR EACH ROW EXECUTE FUNCTION public.message_before_insert_callback();

--
-- Name: contact_histories remove_old_history_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER remove_old_history_trigger AFTER
INSERT ON public.contact_histories
FOR EACH ROW EXECUTE FUNCTION public.remove_old_history();

--
-- Name: contacts_tags update_contact_updated_at_on_tagging_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_contact_updated_at_on_tagging_trigger AFTER
INSERT
OR
DELETE
OR
UPDATE ON public.contacts_tags
FOR EACH ROW EXECUTE FUNCTION public.update_contact_updated_at_on_tagging();

--
-- Name: contacts_groups update_contact_updated_at_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_contact_updated_at_trigger AFTER
INSERT
OR
DELETE
OR
UPDATE ON public.contacts_groups
...
CREATE TRIGGER update_flow_revision_number_trigger AFTER
INSERT ON public.flow_revisions
FOR EACH ROW EXECUTE FUNCTION public.update_flow_revision_number();

--
-- Name: messages_tags update_message_updated_at_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_message_updated_at_trigger AFTER
INSERT
OR
DELETE
OR
UPDATE ON public.messages_tags
FOR EACH ROW EXECUTE FUNCTION public.update_message_updated_at();

--
-- Name: organizations update_organization_id_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_organization_id_trigger AFTER
INSERT ON public.organizations
FOR EACH ROW EXECUTE FUNCTION public.update_organization_id();

--
-- Name: contact_histories update_profile_id_on_new_contact_history; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_profile_id_on_new_contact_history AFTER
INSERT ON public.contact_histories
FOR EACH ROW EXECUTE FUNCTION public.update_profile_id_on_new_contact_history();

--
-- Name: flow_contexts update_profile_id_on_new_flow_context; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_profile_id_on_new_flow_context AFTER
INSERT ON public.flow_contexts
FOR EACH ROW EXECUTE FUNCTION public.update_profile_id_on_new_flow_context();

--
-- Name: flow_results update_profile_id_on_new_flow_result; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_profile_id_on_new_flow_result AFTER
INSERT ON public.flow_results
FOR EACH ROW EXECUTE FUNCTION public.update_profile_id_on_new_flow_result();

--
-- Name: tags update_tag_ancestors_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_tag_ancestors_trigger AFTER
UPDATE OF parent_id ON public.tags
FOR EACH STATEMENT EXECUTE FUNCTION public.update_tag_ancestors();
...
ALTER TABLE ONLY public.bigquery_jobs ADD CONSTRAINT bigquery_jobs_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.billings ADD CONSTRAINT billings_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.consulting_hours ADD CONSTRAINT consulting_hours_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.contact_histories ADD CONSTRAINT contact_histories_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contact_histories ADD CONSTRAINT contact_histories_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contact_histories ADD CONSTRAINT contact_histories_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.contacts ADD CONSTRAINT contacts_active_profile_id_fkey
FOREIGN KEY (active_profile_id) REFERENCES public.profiles(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.contacts_fields ADD CONSTRAINT contacts_fields_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts_groups ADD CONSTRAINT contacts_groups_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts_groups ADD CONSTRAINT contacts_groups_group_id_fkey
FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts_groups ADD CONSTRAINT contacts_groups_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts ADD CONSTRAINT contacts_language_id_fkey
FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE ONLY public.contacts ADD CONSTRAINT contacts_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts_tags ADD CONSTRAINT contacts_tags_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts_tags ADD CONSTRAINT contacts_tags_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.contacts_tags ADD CONSTRAINT contacts_tags_tag_id_fkey
FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.credentials ADD CONSTRAINT credentials_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.credentials ADD CONSTRAINT credentials_provider_id_fkey
FOREIGN KEY (provider_id) REFERENCES global.providers(id);

--
-- Name: extensions extensions_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extensions ADD CONSTRAINT extensions_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcast_contacts ADD CONSTRAINT flow_broadcast_contacts_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcast_contacts ADD CONSTRAINT flow_broadcast_contacts_flow_broadcast_id_fkey
FOREIGN KEY (message_broadcast_id) REFERENCES public.message_broadcasts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcast_contacts ADD CONSTRAINT flow_broadcast_contacts_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT flow_broadcasts_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT flow_broadcasts_group_id_fkey
FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT flow_broadcasts_message_id_fkey
FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT flow_broadcasts_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT flow_broadcasts_user_id_fkey
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_flow_broadcast_id_fkey
FOREIGN KEY (message_broadcast_id) REFERENCES public.message_broadcasts(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_group_message_id_fkey
FOREIGN KEY (group_message_id) REFERENCES public.messages(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_parent_id_fkey
FOREIGN KEY (parent_id) REFERENCES public.flow_contexts(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.flow_contexts ADD CONSTRAINT flow_contexts_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.flow_counts ADD CONSTRAINT flow_counts_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_counts ADD CONSTRAINT flow_counts_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_labels ADD CONSTRAINT flow_labels_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_results ADD CONSTRAINT flow_results_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_results ADD CONSTRAINT flow_results_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_results ADD CONSTRAINT flow_results_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_results ADD CONSTRAINT flow_results_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.flow_revisions ADD CONSTRAINT flow_revisions_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_revisions ADD CONSTRAINT flow_revisions_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_revisions ADD CONSTRAINT flow_revisions_user_id_fkey
FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.flow_roles ADD CONSTRAINT flow_roles_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_roles ADD CONSTRAINT flow_roles_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flow_roles ADD CONSTRAINT flow_roles_role_id_fkey
...
ALTER TABLE ONLY public.flows ADD CONSTRAINT flows_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.flows ADD CONSTRAINT flows_tag_id_fkey
...
ALTER TABLE ONLY public.gcs_jobs ADD CONSTRAINT gcs_jobs_message_media_id_fkey
FOREIGN KEY (message_media_id) REFERENCES public.messages_media(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.gcs_jobs ADD CONSTRAINT gcs_jobs_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.group_roles ADD CONSTRAINT group_roles_group_id_fkey
FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.group_roles ADD CONSTRAINT group_roles_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.group_roles ADD CONSTRAINT group_roles_role_id_fkey
FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.groups ADD CONSTRAINT groups_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.intents ADD CONSTRAINT intents_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.interactive_templates ADD CONSTRAINT interactive_templates_language_id_fkey
FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE ONLY public.interactive_templates ADD CONSTRAINT interactive_templates_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.interactive_templates ADD CONSTRAINT interactive_templates_tag_id_fkey
FOREIGN KEY (tag_id) REFERENCES public.tags(id);
...
ALTER TABLE ONLY public.invoices ADD CONSTRAINT invoices_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.locations ADD CONSTRAINT locations_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.locations ADD CONSTRAINT locations_message_id_fkey
FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.locations ADD CONSTRAINT locations_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.mail_logs ADD CONSTRAINT mail_logs_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.message_broadcasts ADD CONSTRAINT message_broadcasts_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_context_message_id_fkey
FOREIGN KEY (context_message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages_conversations ADD CONSTRAINT messages_conversations_message_id_fkey
FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages_conversations ADD CONSTRAINT messages_conversations_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_flow_broadcast_id_fkey
FOREIGN KEY (message_broadcast_id) REFERENCES public.message_broadcasts(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_group_id_fkey
FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_group_message_id_fkey
FOREIGN KEY (group_message_id) REFERENCES public.messages(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_interactive_template_id_fkey
FOREIGN KEY (interactive_template_id) REFERENCES public.interactive_templates(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_media_id_fkey
FOREIGN KEY (media_id) REFERENCES public.messages_media(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages_media ADD CONSTRAINT messages_media_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET NULL;
...
FOREIGN KEY (receiver_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_sender_id_fkey
FOREIGN KEY (sender_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages_tags ADD CONSTRAINT messages_tags_message_id_fkey
FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages_tags ADD CONSTRAINT messages_tags_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages_tags ADD CONSTRAINT messages_tags_tag_id_fkey
FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_template_id_fkey
FOREIGN KEY (template_id) REFERENCES public.session_templates(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.messages ADD CONSTRAINT messages_user_id_fkey
FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.notifications ADD CONSTRAINT notifications_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.organization_data ADD CONSTRAINT organization_data_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.organizations ADD CONSTRAINT organizations_default_language_id_fkey
FOREIGN KEY (default_language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE ONLY public.organizations ADD CONSTRAINT organizations_newcontact_flow_id_fkey
FOREIGN KEY (newcontact_flow_id) REFERENCES public.flows(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.organizations ADD CONSTRAINT organizations_optin_flow_id_fkey
FOREIGN KEY (optin_flow_id) REFERENCES public.flows(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.organizations ADD CONSTRAINT organizations_provider_id_fkey
FOREIGN KEY (bsp_id) REFERENCES global.providers(id);

--
-- Name: profiles profiles_contact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.profiles ADD CONSTRAINT profiles_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.profiles ADD CONSTRAINT profiles_language_id_fkey
FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.profiles ADD CONSTRAINT profiles_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.role_permissions ADD CONSTRAINT role_permissions_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.role_permissions ADD CONSTRAINT role_permissions_permission_id_fkey
FOREIGN KEY (permission_id) REFERENCES global.permissions(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.role_permissions ADD CONSTRAINT role_permissions_role_id_fkey
FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.roles ADD CONSTRAINT roles_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.saas ADD CONSTRAINT saas_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.saved_searches ADD CONSTRAINT saved_searches_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.session_templates ADD CONSTRAINT session_templates_language_id_fkey
FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE ONLY public.session_templates ADD CONSTRAINT session_templates_message_media_id_fkey
FOREIGN KEY (message_media_id) REFERENCES public.messages_media(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.session_templates ADD CONSTRAINT session_templates_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.session_templates ADD CONSTRAINT session_templates_parent_id_fkey
FOREIGN KEY (parent_id) REFERENCES public.session_templates(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.session_templates ADD CONSTRAINT session_templates_tag_id_fkey
FOREIGN KEY (tag_id) REFERENCES public.tags(id);
...
ALTER TABLE ONLY public.sheets_data ADD CONSTRAINT sheets_data_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.sheets_data ADD CONSTRAINT sheets_data_sheet_id_fkey
FOREIGN KEY (sheet_id) REFERENCES public.sheets(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.sheets ADD CONSTRAINT sheets_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.stats ADD CONSTRAINT stats_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.tags ADD CONSTRAINT tags_language_id_fkey
FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE ONLY public.tags ADD CONSTRAINT tags_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.tags ADD CONSTRAINT tags_parent_id_fkey
FOREIGN KEY (parent_id) REFERENCES public.tags(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.templates_tags ADD CONSTRAINT templates_tags_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.templates_tags ADD CONSTRAINT templates_tags_tag_id_fkey
FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.templates_tags ADD CONSTRAINT templates_tags_template_id_fkey
FOREIGN KEY (template_id) REFERENCES public.session_templates(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.tickets ADD CONSTRAINT tickets_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.tickets ADD CONSTRAINT tickets_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.tickets ADD CONSTRAINT tickets_user_id_fkey
FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET NULL;
...
ALTER TABLE ONLY public.trackers ADD CONSTRAINT trackers_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.trigger_logs ADD CONSTRAINT trigger_logs_flow_context_id_fkey
FOREIGN KEY (flow_context_id) REFERENCES public.flow_contexts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.trigger_logs ADD CONSTRAINT trigger_logs_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.trigger_logs ADD CONSTRAINT trigger_logs_trigger_id_fkey
FOREIGN KEY (trigger_id) REFERENCES public.triggers(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.trigger_roles ADD CONSTRAINT trigger_roles_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.trigger_roles ADD CONSTRAINT trigger_roles_role_id_fkey
FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.trigger_roles ADD CONSTRAINT trigger_roles_trigger_id_fkey
FOREIGN KEY (trigger_id) REFERENCES public.triggers(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.triggers ADD CONSTRAINT triggers_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.triggers ADD CONSTRAINT triggers_group_id_fkey
FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.triggers ADD CONSTRAINT triggers_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.user_roles ADD CONSTRAINT user_roles_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.user_roles ADD CONSTRAINT user_roles_role_id_fkey
FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.user_roles ADD CONSTRAINT user_roles_user_id_fkey
FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users ADD CONSTRAINT users_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users_groups ADD CONSTRAINT users_groups_group_id_fkey
FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users_groups ADD CONSTRAINT users_groups_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users_groups ADD CONSTRAINT users_groups_user_id_fkey
FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users ADD CONSTRAINT users_language_id_fkey
FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE ONLY public.users ADD CONSTRAINT users_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users_tokens ADD CONSTRAINT users_tokens_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.users_tokens ADD CONSTRAINT users_tokens_user_id_fkey
FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.webhook_logs ADD CONSTRAINT webhook_logs_contact_id_fkey
FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.webhook_logs ADD CONSTRAINT webhook_logs_flow_id_fkey
FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.webhook_logs ADD CONSTRAINT webhook_logs_organization_id_fkey
FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
