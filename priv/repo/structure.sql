...
--
CREATE FUNCTION global.oban_jobs_notify() RETURNS trigger LANGUAGE plpgsql AS $ $ DECLARE channel text;

notice json;

BEGIN IF NEW.state = 'available' THEN channel = 'global.oban_insert';
...
--
CREATE FUNCTION public.message_after_insert_callback() RETURNS trigger LANGUAGE plpgsql AS $ $ DECLARE session_lim BIGINT;
...
BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
IF (
  current_diff < session_lim
  AND current_session_uuid IS NOT NULL
) THEN session_uuid_value = current_session_uuid;

ELSE session_uuid_value = (
  SELECT
    uuid_generate_v4()
);
...
--
CREATE FUNCTION public.message_before_insert_callback() RETURNS trigger LANGUAGE plpgsql AS $ $ DECLARE now TIMESTAMP WITH TIME ZONE;
...
IF (TG_OP = 'INSERT') THEN now := (CURRENT_TIMESTAMP at time zone 'utc');
...
IF (var_message_number IS NULL) THEN var_message_number = 0;
...
IF (NEW.flow = 'inbound') THEN IF (NEW.context_id IS NOT NULL) THEN
SELECT
...
--
CREATE FUNCTION public.remove_old_history() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN with ranked as (
  SELECT
    id,
    row_number() over (
...
--
CREATE FUNCTION public.update_contact_updated_at() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
--
CREATE FUNCTION public.update_contact_updated_at_on_tagging() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
--
CREATE FUNCTION public.update_flow_revision_number() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN IF (TG_OP = 'INSERT') THEN
UPDATE
  flow_revisions
set
...
--
CREATE FUNCTION public.update_message_number() RETURNS trigger LANGUAGE plpgsql AS $ $ DECLARE message_ids BIGINT [];
...
IF(
  NEW.group_id > 0
  AND NEW.sender_id = NEW.receiver_id
) THEN
SELECT
  last_message_number INTO var_message_number
FROM
...
--
CREATE FUNCTION public.update_message_updated_at() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN IF (
  TG_OP = 'INSERT'
  OR TG_OP = 'UPDATE'
) THEN
UPDATE
...
--
CREATE FUNCTION public.update_organization_id() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN
UPDATE
  organizations
set
  organization_id = id;
...
--
CREATE FUNCTION public.update_profile_id_on_new_contact_history() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
--
CREATE FUNCTION public.update_profile_id_on_new_flow_context() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
--
CREATE FUNCTION public.update_profile_id_on_new_flow_result() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
--
CREATE FUNCTION public.update_profile_id_on_new_message() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
...
--
CREATE FUNCTION public.update_tag_ancestors() RETURNS trigger LANGUAGE plpgsql AS $ $ BEGIN WITH RECURSIVE parents AS (
  SELECT
    id AS id,
...
--
CREATE SEQUENCE global.fun_with_flags_toggles_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE global.languages_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE global.oban_jobs (
  ...
  CONSTRAINT attempt_range CHECK (
    (
      (attempt >= 0)
  ...
  CONSTRAINT worker_length CHECK (
    (
      (char_length(worker) > 0)
...
--
CREATE SEQUENCE global.oban_jobs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE global.permissions_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE global.providers_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.bigquery_jobs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.billings_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.consulting_hours_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.contact_histories_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.contacts_fields_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.contacts_groups_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.contacts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.contacts_tags_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.extensions_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_broadcast_contacts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_broadcasts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_contexts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_counts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_labels_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_results_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_revisions_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flow_roles_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.flows_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.gcs_jobs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.group_roles_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.intents_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.interactive_templates_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.locations_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.mail_logs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.messages_conversations_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.messages_media_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.messages_tags_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.organization_data_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.saas_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.saved_searches_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.session_templates_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.sheets_data_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.sheets_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.templates_tags_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.tickets_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.trackers_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.trigger_logs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.trigger_roles_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.users_groups_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.users_tokens_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.webhook_logs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
ALTER TABLE
  ONLY global.fun_with_flags_toggles
ALTER COLUMN
  id
SET
  DEFAULT nextval('global.fun_with_flags_toggles_id_seq' :: regclass);

--
-- Name: languages id; Type: DEFAULT; Schema: global; Owner: -
--
ALTER TABLE
  ONLY global.languages
ALTER COLUMN
  id
SET
  DEFAULT nextval('global.languages_id_seq' :: regclass);

--
-- Name: oban_jobs id; Type: DEFAULT; Schema: global; Owner: -
--
ALTER TABLE
  ONLY global.oban_jobs
ALTER COLUMN
  id
SET
  DEFAULT nextval('global.oban_jobs_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('global.permissions_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('global.providers_id_seq' :: regclass);

--
-- Name: bigquery_jobs id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.bigquery_jobs
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.bigquery_jobs_id_seq' :: regclass);

--
-- Name: billings id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.billings
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.billings_id_seq' :: regclass);

--
-- Name: consulting_hours id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.consulting_hours
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.consulting_hours_id_seq' :: regclass);

--
-- Name: contact_histories id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.contact_histories
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.contact_histories_id_seq' :: regclass);

--
-- Name: contacts id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.contacts
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.contacts_id_seq' :: regclass);

--
-- Name: contacts_fields id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.contacts_fields
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.contacts_fields_id_seq' :: regclass);

--
-- Name: contacts_groups id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.contacts_groups
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.contacts_groups_id_seq' :: regclass);

--
-- Name: contacts_tags id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.contacts_tags
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.contacts_tags_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.credentials_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.extensions_id_seq' :: regclass);

--
-- Name: flow_contexts id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.flow_contexts
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_contexts_id_seq' :: regclass);

--
-- Name: flow_counts id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.flow_counts
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_counts_id_seq' :: regclass);

--
-- Name: flow_labels id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.flow_labels
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_labels_id_seq' :: regclass);

--
-- Name: flow_results id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.flow_results
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_results_id_seq' :: regclass);

--
-- Name: flow_revisions id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.flow_revisions
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_revisions_id_seq' :: regclass);

--
-- Name: flow_roles id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.flow_roles
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_roles_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flows_id_seq' :: regclass);

--
-- Name: gcs_jobs id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.gcs_jobs
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.gcs_jobs_id_seq' :: regclass);

--
-- Name: group_roles id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.group_roles
ALTER COLUMN
  id
SET
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.intents_id_seq' :: regclass);

--
-- Name: interactive_templates id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.interactive_templates
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.interactive_templates_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.invoices_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.locations_id_seq' :: regclass);

--
-- Name: mail_logs id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.mail_logs
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.mail_logs_id_seq' :: regclass);

--
-- Name: message_broadcast_contacts id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.message_broadcast_contacts
ALTER COLUMN
  id
SET
  DEFAULT nextval(
    'public.flow_broadcast_contacts_id_seq' :: regclass
  );
...
--
ALTER TABLE
  ONLY public.message_broadcasts
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.flow_broadcasts_id_seq' :: regclass);
...
--
ALTER TABLE
  ONLY public.messages_conversations
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.messages_conversations_id_seq' :: regclass);

--
-- Name: messages_media id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.messages_media
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.messages_media_id_seq' :: regclass);

--
-- Name: messages_tags id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.messages_tags
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.messages_tags_id_seq' :: regclass);
...
--
ALTER TABLE
  ONLY public.organization_data
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.organization_data_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.organizations_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.profiles_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.role_permissions_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.saas_id_seq' :: regclass);

--
-- Name: saved_searches id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.saved_searches
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.saved_searches_id_seq' :: regclass);

--
-- Name: session_templates id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.session_templates
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.session_templates_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.sheets_id_seq' :: regclass);

--
-- Name: sheets_data id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.sheets_data
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.sheets_data_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.stats_id_seq' :: regclass);
...
--
ALTER TABLE
  ONLY public.templates_tags
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.templates_tags_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.tickets_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.trackers_id_seq' :: regclass);

--
-- Name: trigger_logs id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.trigger_logs
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.trigger_logs_id_seq' :: regclass);

--
-- Name: trigger_roles id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.trigger_roles
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.trigger_roles_id_seq' :: regclass);
...
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.triggers_id_seq' :: regclass);
...
--
ALTER TABLE
  ONLY public.users_groups
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.users_groups_id_seq' :: regclass);

--
-- Name: users_tokens id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.users_tokens
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.users_tokens_id_seq' :: regclass);

--
-- Name: webhook_logs id; Type: DEFAULT; Schema: public; Owner: -
--
ALTER TABLE
  ONLY public.webhook_logs
ALTER COLUMN
  id
SET
  DEFAULT nextval('public.webhook_logs_id_seq' :: regclass);
...
ALTER TABLE
  ONLY global.fun_with_flags_toggles
ADD
  CONSTRAINT fun_with_flags_toggles_pkey PRIMARY KEY (id);
...
--
ALTER TABLE
  ONLY global.oban_producers
ADD
  CONSTRAINT oban_producers_pkey PRIMARY KEY (uuid);
...
ALTER TABLE
  ONLY public.bigquery_jobs
ADD
  CONSTRAINT bigquery_jobs_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.consulting_hours
ADD
  CONSTRAINT consulting_hours_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.contacts_fields
ADD
  CONSTRAINT contacts_fields_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.contacts_tags
ADD
  CONSTRAINT contacts_tags_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.message_broadcast_contacts
ADD
  CONSTRAINT flow_broadcast_contacts_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT flow_broadcasts_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.flow_counts
ADD
  CONSTRAINT flow_counts_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.flow_results
ADD
  CONSTRAINT flow_results_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.flow_roles
ADD
  CONSTRAINT flow_roles_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.gcs_jobs
ADD
  CONSTRAINT gcs_jobs_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.messages_conversations
ADD
  CONSTRAINT messages_conversations_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.messages_tags
ADD
  CONSTRAINT messages_tags_pkey PRIMARY KEY (id);
...
--
ALTER TABLE
  ONLY public.schema_seeds
ADD
  CONSTRAINT schema_seeds_pkey PRIMARY KEY (
    version,
    tenant
  );
...
ALTER TABLE
  ONLY public.sheets_data
ADD
  CONSTRAINT sheets_data_pkey PRIMARY KEY (id);
...
ALTER TABLE
  ONLY public.trigger_roles
ADD
  CONSTRAINT trigger_roles_pkey PRIMARY KEY (id);
...
WHERE
  (message_broadcast_id IS NOT NULL);
...
WHERE
  (context_message_id IS NOT NULL);
...
WHERE
  (interactive_template_id IS NOT NULL);
...
AFTER
INSERT
  ON global.oban_jobs FOR EACH ROW EXECUTE FUNCTION global.oban_jobs_notify();
...
AFTER
  DELETE ON public.tags FOR EACH STATEMENT EXECUTE FUNCTION public.update_tag_ancestors();
...
AFTER
INSERT
  ON public.tags FOR EACH STATEMENT EXECUTE FUNCTION public.update_tag_ancestors();
...
AFTER
INSERT
  ON public.messages FOR EACH ROW EXECUTE FUNCTION public.message_after_insert_callback();

--
-- Name: messages message_before_insert_trigger; Type: TRIGGER; Schema: public; Owner: -
--
CREATE TRIGGER message_before_insert_trigger BEFORE
INSERT
  ON public.messages FOR EACH ROW EXECUTE FUNCTION public.message_before_insert_callback();
...
AFTER
INSERT
  ON public.contact_histories FOR EACH ROW EXECUTE FUNCTION public.remove_old_history();
...
INSERT
  ...
  OR
UPDATE
  ON public.contacts_tags FOR EACH ROW EXECUTE FUNCTION public.update_contact_updated_at_on_tagging();
...
INSERT
  ...
  OR
UPDATE
  ON public.contacts_groups FOR EACH ROW EXECUTE FUNCTION public.update_contact_updated_at();
...
AFTER
INSERT
  ON public.flow_revisions FOR EACH ROW EXECUTE FUNCTION public.update_flow_revision_number();
...
INSERT
  ...
  OR
UPDATE
  ON public.messages_tags FOR EACH ROW EXECUTE FUNCTION public.update_message_updated_at();
...
AFTER
INSERT
  ON public.organizations FOR EACH ROW EXECUTE FUNCTION public.update_organization_id();
...
AFTER
INSERT
  ON public.contact_histories FOR EACH ROW EXECUTE FUNCTION public.update_profile_id_on_new_contact_history();
...
AFTER
INSERT
  ON public.flow_contexts FOR EACH ROW EXECUTE FUNCTION public.update_profile_id_on_new_flow_context();
...
AFTER
INSERT
  ON public.flow_results FOR EACH ROW EXECUTE FUNCTION public.update_profile_id_on_new_flow_result();
...
AFTER
UPDATE
  OF parent_id ON public.tags FOR EACH STATEMENT EXECUTE FUNCTION public.update_tag_ancestors();
...
ALTER TABLE
  ONLY public.bigquery_jobs
ADD
  CONSTRAINT bigquery_jobs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.billings
ADD
  CONSTRAINT billings_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.consulting_hours
ADD
  CONSTRAINT consulting_hours_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.contact_histories
ADD
  CONSTRAINT contact_histories_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contact_histories
ADD
  CONSTRAINT contact_histories_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contact_histories
ADD
  CONSTRAINT contact_histories_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.contacts
ADD
  CONSTRAINT contacts_active_profile_id_fkey FOREIGN KEY (active_profile_id) REFERENCES public.profiles(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.contacts_fields
ADD
  CONSTRAINT contacts_fields_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts_groups
ADD
  CONSTRAINT contacts_groups_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts_groups
ADD
  CONSTRAINT contacts_groups_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts_groups
ADD
  CONSTRAINT contacts_groups_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts
ADD
  CONSTRAINT contacts_language_id_fkey FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE
  ONLY public.contacts
ADD
  CONSTRAINT contacts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts_tags
ADD
  CONSTRAINT contacts_tags_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts_tags
ADD
  CONSTRAINT contacts_tags_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.contacts_tags
ADD
  CONSTRAINT contacts_tags_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.credentials
ADD
  CONSTRAINT credentials_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.credentials
ADD
  CONSTRAINT credentials_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES global.providers(id);
...
ALTER TABLE
  ONLY public.extensions
ADD
  CONSTRAINT extensions_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcast_contacts
ADD
  CONSTRAINT flow_broadcast_contacts_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcast_contacts
ADD
  CONSTRAINT flow_broadcast_contacts_flow_broadcast_id_fkey FOREIGN KEY (message_broadcast_id) REFERENCES public.message_broadcasts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcast_contacts
ADD
  CONSTRAINT flow_broadcast_contacts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT flow_broadcasts_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT flow_broadcasts_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT flow_broadcasts_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT flow_broadcasts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT flow_broadcasts_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_flow_broadcast_id_fkey FOREIGN KEY (message_broadcast_id) REFERENCES public.message_broadcasts(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_group_message_id_fkey FOREIGN KEY (group_message_id) REFERENCES public.messages(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.flow_contexts(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_contexts
ADD
  CONSTRAINT flow_contexts_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_counts
ADD
  CONSTRAINT flow_counts_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_counts
ADD
  CONSTRAINT flow_counts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_labels
ADD
  CONSTRAINT flow_labels_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_results
ADD
  CONSTRAINT flow_results_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_results
ADD
  CONSTRAINT flow_results_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_results
ADD
  CONSTRAINT flow_results_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_results
ADD
  CONSTRAINT flow_results_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_revisions
ADD
  CONSTRAINT flow_revisions_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_revisions
ADD
  CONSTRAINT flow_revisions_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_revisions
ADD
  CONSTRAINT flow_revisions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.flow_roles
ADD
  CONSTRAINT flow_roles_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_roles
ADD
  CONSTRAINT flow_roles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flow_roles
ADD
  CONSTRAINT flow_roles_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flows
ADD
  CONSTRAINT flows_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.flows
ADD
  CONSTRAINT flows_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tags(id);
...
ALTER TABLE
  ONLY public.gcs_jobs
ADD
  CONSTRAINT gcs_jobs_message_media_id_fkey FOREIGN KEY (message_media_id) REFERENCES public.messages_media(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.gcs_jobs
ADD
  CONSTRAINT gcs_jobs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.group_roles
ADD
  CONSTRAINT group_roles_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.group_roles
ADD
  CONSTRAINT group_roles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.group_roles
ADD
  CONSTRAINT group_roles_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.groups
ADD
  CONSTRAINT groups_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.intents
ADD
  CONSTRAINT intents_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.interactive_templates
ADD
  CONSTRAINT interactive_templates_language_id_fkey FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE
  ONLY public.interactive_templates
ADD
  CONSTRAINT interactive_templates_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.interactive_templates
ADD
  CONSTRAINT interactive_templates_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tags(id);
...
ALTER TABLE
  ONLY public.invoices
ADD
  CONSTRAINT invoices_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.locations
ADD
  CONSTRAINT locations_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.locations
ADD
  CONSTRAINT locations_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.locations
ADD
  CONSTRAINT locations_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.mail_logs
ADD
  CONSTRAINT mail_logs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.message_broadcasts
ADD
  CONSTRAINT message_broadcasts_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_context_message_id_fkey FOREIGN KEY (context_message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages_conversations
ADD
  CONSTRAINT messages_conversations_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages_conversations
ADD
  CONSTRAINT messages_conversations_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_flow_broadcast_id_fkey FOREIGN KEY (message_broadcast_id) REFERENCES public.message_broadcasts(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_group_message_id_fkey FOREIGN KEY (group_message_id) REFERENCES public.messages(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_interactive_template_id_fkey FOREIGN KEY (interactive_template_id) REFERENCES public.interactive_templates(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_media_id_fkey FOREIGN KEY (media_id) REFERENCES public.messages_media(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages_media
ADD
  CONSTRAINT messages_media_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_receiver_id_fkey FOREIGN KEY (receiver_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages_tags
ADD
  CONSTRAINT messages_tags_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages_tags
ADD
  CONSTRAINT messages_tags_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages_tags
ADD
  CONSTRAINT messages_tags_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_template_id_fkey FOREIGN KEY (template_id) REFERENCES public.session_templates(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.messages
ADD
  CONSTRAINT messages_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.notifications
ADD
  CONSTRAINT notifications_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.organization_data
ADD
  CONSTRAINT organization_data_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.organizations
ADD
  CONSTRAINT organizations_default_language_id_fkey FOREIGN KEY (default_language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE
  ONLY public.organizations
ADD
  CONSTRAINT organizations_newcontact_flow_id_fkey FOREIGN KEY (newcontact_flow_id) REFERENCES public.flows(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.organizations
ADD
  CONSTRAINT organizations_optin_flow_id_fkey FOREIGN KEY (optin_flow_id) REFERENCES public.flows(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.organizations
ADD
  CONSTRAINT organizations_provider_id_fkey FOREIGN KEY (bsp_id) REFERENCES global.providers(id);
...
ALTER TABLE
  ONLY public.profiles
ADD
  CONSTRAINT profiles_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.profiles
ADD
  CONSTRAINT profiles_language_id_fkey FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.profiles
ADD
  CONSTRAINT profiles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.role_permissions
ADD
  CONSTRAINT role_permissions_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.role_permissions
ADD
  CONSTRAINT role_permissions_permission_id_fkey FOREIGN KEY (permission_id) REFERENCES global.permissions(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.role_permissions
ADD
  CONSTRAINT role_permissions_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.roles
ADD
  CONSTRAINT roles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.saas
ADD
  CONSTRAINT saas_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.saved_searches
ADD
  CONSTRAINT saved_searches_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.session_templates
ADD
  CONSTRAINT session_templates_language_id_fkey FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE
  ONLY public.session_templates
ADD
  CONSTRAINT session_templates_message_media_id_fkey FOREIGN KEY (message_media_id) REFERENCES public.messages_media(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.session_templates
ADD
  CONSTRAINT session_templates_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.session_templates
ADD
  CONSTRAINT session_templates_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.session_templates(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.session_templates
ADD
  CONSTRAINT session_templates_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tags(id);
...
ALTER TABLE
  ONLY public.sheets_data
ADD
  CONSTRAINT sheets_data_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.sheets_data
ADD
  CONSTRAINT sheets_data_sheet_id_fkey FOREIGN KEY (sheet_id) REFERENCES public.sheets(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.sheets
ADD
  CONSTRAINT sheets_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.stats
ADD
  CONSTRAINT stats_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.tags
ADD
  CONSTRAINT tags_language_id_fkey FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE
  ONLY public.tags
ADD
  CONSTRAINT tags_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.tags
ADD
  CONSTRAINT tags_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.tags(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.templates_tags
ADD
  CONSTRAINT templates_tags_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.templates_tags
ADD
  CONSTRAINT templates_tags_tag_id_fkey FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.templates_tags
ADD
  CONSTRAINT templates_tags_template_id_fkey FOREIGN KEY (template_id) REFERENCES public.session_templates(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.tickets
ADD
  CONSTRAINT tickets_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.tickets
ADD
  CONSTRAINT tickets_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.tickets
ADD
  CONSTRAINT tickets_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE
SET
  NULL;
...
ALTER TABLE
  ONLY public.trackers
ADD
  CONSTRAINT trackers_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.trigger_logs
ADD
  CONSTRAINT trigger_logs_flow_context_id_fkey FOREIGN KEY (flow_context_id) REFERENCES public.flow_contexts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.trigger_logs
ADD
  CONSTRAINT trigger_logs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.trigger_logs
ADD
  CONSTRAINT trigger_logs_trigger_id_fkey FOREIGN KEY (trigger_id) REFERENCES public.triggers(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.trigger_roles
ADD
  CONSTRAINT trigger_roles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.trigger_roles
ADD
  CONSTRAINT trigger_roles_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.trigger_roles
ADD
  CONSTRAINT trigger_roles_trigger_id_fkey FOREIGN KEY (trigger_id) REFERENCES public.triggers(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.triggers
ADD
  CONSTRAINT triggers_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.triggers
ADD
  CONSTRAINT triggers_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.triggers
ADD
  CONSTRAINT triggers_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.user_roles
ADD
  CONSTRAINT user_roles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.user_roles
ADD
  CONSTRAINT user_roles_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.user_roles
ADD
  CONSTRAINT user_roles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users
ADD
  CONSTRAINT users_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users_groups
ADD
  CONSTRAINT users_groups_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users_groups
ADD
  CONSTRAINT users_groups_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users_groups
ADD
  CONSTRAINT users_groups_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users
ADD
  CONSTRAINT users_language_id_fkey FOREIGN KEY (language_id) REFERENCES global.languages(id) ON
DELETE RESTRICT;
...
ALTER TABLE
  ONLY public.users
ADD
  CONSTRAINT users_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users_tokens
ADD
  CONSTRAINT users_tokens_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.users_tokens
ADD
  CONSTRAINT users_tokens_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.webhook_logs
ADD
  CONSTRAINT webhook_logs_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.webhook_logs
ADD
  CONSTRAINT webhook_logs_flow_id_fkey FOREIGN KEY (flow_id) REFERENCES public.flows(id) ON
DELETE CASCADE;
...
ALTER TABLE
  ONLY public.webhook_logs
ADD
  CONSTRAINT webhook_logs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON
DELETE CASCADE;
