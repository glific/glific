          ...
          IF (NEW.flow = 'inbound') THEN
            UPDATE contacts
              SET
                ...
                last_message_at = (CURRENT_TIMESTAMP at time zone 'utc')
            ...
            UPDATE messages
              SET
                ...
                is_read = CASE
                  WHEN flow = 'inbound' THEN true
                  ELSE is_read
                END
                is_replied = CASE
                  WHEN flow = 'outbound' THEN true
                  ELSE is_replied
                END
              WHERE contact_id = NEW.contact_id AND id < NEW.id
            ...
            UPDATE messages
              SET
                message_number = 0, is_read = false, is_replied = false,
