defmodule Glific.Repo.Migrations.V0_9_2_AlterUpdateMesaageNumberTrigger do
  use Ecto.Migration
      ...
      IF (TG_OP = 'INSERT') THEN
        ...
        ELSE
          ...
          IF (NEW.flow = 'inbound') THEN
            session_limit := (SELECT session_limit * 60 FROM organizations WHERE id = NEW.organization_id LIMIT 1);
            ...
            IF (current_diff < session_limit AND current_session_uuid is not null) THEN
