defmodule Glific.Repo.Migrations.AddStatusToMessages do
  ...
  defp messages() do
    alter table(:messages) do
      ...
      add :is_read, :boolean, default: false, comment: "Whether the message was read (inbound messages)"
      ...
      add :is_replied, :boolean, default: false, comment: "For inbound messages - whether organisation has replied to the message; for outbound message - Whether recipient has replied to the message"
    end
