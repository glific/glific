defmodule Glific.Repo.Migrations.AddBlocksToInteractiveMessageTypeEnum do
  use Ecto.Migration
  ...
  def up do
    execute("ALTER TYPE interactive_message_type_enum ADD VALUE IF NOT EXISTS 'blocks'")
  end
