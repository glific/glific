defmodule GlificWeb.Providers.Glifproxy.Controllers.MessageEventController do
  @moduledoc """
  ...
  @doc """
  Message status when the message has been sent to glifproxy
  """
  ...
  @doc """
  Message status when glifproxy could not send the message to whats app
  """
  ...
  @doc """
  Message has been sent to whats app via Glifproxy
  """
  ...
  defp update_status(conn, params, status) do
    ...
    Communications.Message.update_provider_status(provider_message_id, status)
