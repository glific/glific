defmodule Glific.Seeds.SeedsMigration do
  ...
  defp do_migrate_data(:template_flows, organizations), do: SeedsFlows.add_template_flows(organizations)
  ...
  def fix_message_number_for_contact(contact_id) do
    ...
    |> Enum.each(&Repo.query!(&1, [], timeout: 100_000, skip_organization_id: true))
