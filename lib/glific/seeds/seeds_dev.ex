if Code.ensure_loaded?(Faker) do
  defmodule Glific.Seeds.SeedsDev do
    ...
    def seed_flow_results(organization \\ nil) do
      ...
      create_flow_results(contact1, flow1, organization.id)
      create_flow_results(contact1, flow2, organization.id)
      create_flow_results(contact1, flow1, organization.id)
      create_flow_results(contact1, flow2, organization.id)
      create_flow_results(contact2, flow1, organization.id)
      create_flow_results(contact2, flow2, organization.id)
      create_flow_results(contact2, flow1, organization.id)
      create_flow_results(contact2, flow2, organization.id)
      create_flow_results(contact3, flow1, organization.id)
      create_flow_results(contact3, flow2, organization.id)
      create_flow_results(contact3, flow1, organization.id)
      create_flow_results(contact3, flow2, organization.id)
    end
