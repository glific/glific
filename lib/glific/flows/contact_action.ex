defmodule Glific.Flows.ContactAction do
  ...
  def send_message(
    ...
    {type, media_id} =
      if is_nil(attachments) or attachments == %{} do
        {session_template.type, session_template.message_media_id}
      else
        get_media_from_attachment(attachments, "", context.organization_id)
      end
