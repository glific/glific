defmodule Glific.Taggers.Numeric do
  ...
  @numeric_map %{
    ...
    # emojis as numbers
    to_string(['\u0030', 65039, 8419]) => 0,
    to_string(['\u0031', 65039, 8419]) => 1,
    to_string(['\u0032', 65039, 8419]) => 2,
    to_string(['\u0033', 65039, 8419]) => 3,
    to_string(['\u0034', 65039, 8419]) => 4,
    to_string(['\u0035', 65039, 8419]) => 5,
    to_string(['\u0036', 65039, 8419]) => 6,
    to_string(['\u0037', 65039, 8419]) => 7,
    to_string(['\u0038', 65039, 8419]) => 8,
    to_string(['\u0039', 65039, 8419]) => 9,
  }
