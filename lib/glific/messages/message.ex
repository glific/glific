defmodule Glific.Messages.Message do
  ...
  @type t() :: %__MODULE__{
          ...
          wa_form_id: non_neg_integer | nil,
  ...
  schema "messages" do
    ...
    belongs_to(:wa_form, Glific.WhatsappForms.WhatsappFormResponse, foreign_key: :wa_form_id)
  ...
  defp validate_media(changeset, message) do
    ...
    cond do
      type in [nil, :text, :location, :list, :quick_reply, :location_request_message, :wa_form] ->
        changeset
