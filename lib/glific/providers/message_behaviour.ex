defmodule Glific.Providers.MessageBehaviour do
  ...
  @callback send_image(message :: Glific.Messages.Message.t(), boolean) ::
              {:ok, Oban.Job.t()} | {:error, Ecto.Changeset.t()}

  @callback send_audio(message :: Glific.Messages.Message.t(), boolean) ::
              {:ok, Oban.Job.t()} | {:error, Ecto.Changeset.t()}

  @callback send_video(message :: Glific.Messages.Message.t(), boolean) ::
              {:ok, Oban.Job.t()} | {:error, Ecto.Changeset.t()}

  @callback send_document(message :: Glific.Messages.Message.t(), boolean) ::
              {:ok, Oban.Job.t()} | {:error, Ecto.Changeset.t()}
