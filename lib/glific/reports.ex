defmodule Glific.Reports do
  ...
  """
  def list_reports do
    Repo.all(Report, skip_organization_id: true)
  end
  ...
  """
  def get_report!(id), do: Repo.get!(Report, id, skip_organization_id: true)
  ...
  def delete_report(%Report{} = report) do
    Repo.delete(report, skip_organization_id: true)
  end
