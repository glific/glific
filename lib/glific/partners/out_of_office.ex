defmodule Glific.Partners.OrganizationSettings.OutOfOffice do
  ...
  @optional_fields [
    ...
    :start_time,
    :end_time,
    :flow_id, # this is the legacy out of office flow id
    :default_flow_id, # this is the in office or default flow to start
  ]
  ...
  embedded_schema do
    ...
    belongs_to :default_flow, Flow, foreign_key: :default_flow_id
