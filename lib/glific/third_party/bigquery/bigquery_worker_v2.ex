defmodule Glific.BigQuery.BigQueryWorkerV2 do
  @moduledoc """
  ...
  def perform_periodic(organization_id) do
    ...
    if credential do
      ...
      bigquery_jobs = Jobs.get_bigquery_jobs(organization_id)

      Enum.each(bigquery_jobs, fn bq_job ->
        init_job(bq_job, organization_id)
      end)
    end
  ...
  @spec init_job(BigQuery.BigQueryJob.t() | nil, non_neg_integer) :: any()
  defp init_job(bq_job, org_id) do
    __MODULE__.new(%{
      table: bq_job.table,
