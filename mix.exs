defmodule Glific.MixProject do
  ...
  defp deps do
    [
      ...
      {:absinthe, "~> 1.5"},
      {:absinthe_plug, "~> 1.5"},
      {:absinthe_phoenix, git: "https://github.com/absinthe-graphql/absinthe_phoenix"},
      # {:absinthe_phoenix, "~> 2.0"},
      {:dataloader, "~> 1.0"},
      {:hackney, "~> 1.17"},
      {:tesla, "~> 1.4"},
      {:oban, "~> 2.8"},
      {:oban_web, "~> 2.7", organization: "oban", only: @oban_envs},
      {:oban_pro, "~> 0.8", organization: "oban", only: @oban_envs},
      {:faker, "~> 0.13"},
